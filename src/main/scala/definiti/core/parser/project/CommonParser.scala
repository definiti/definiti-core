...
import definiti.core.parser.antlr.DefinitiParser.{GenericTypeListContext, ParameterDefinitionContext, ParameterListDefinitionContext, TypeReferenceContext}
